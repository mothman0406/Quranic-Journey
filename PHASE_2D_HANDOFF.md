...
**Last updated: 2026-04-29 (Phase 2I.2g bookmark/resume hardware QA passed; next is Phase 2I.2h View in Full Mushaf; beta remains blocked by 2I/2J/2K parity before TestFlight readiness)**
...
- Phase 2I Memorization parity completion is required before TestFlight: 2I.1 overview cards plus save-semantics/rating follow-up, 2I.2a Pause & Save, 2I.2b leave semantics, 2I.2c Recitation Check, 2I.2d Ready to Recite, 2I.2e Just Get Tested, 2I.2f Pre-session setup, 2I.2g bookmark/resume, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are hardware-tested; remaining session settings/defaults, View in Full Mushaf, and a visible memorization settings/defaults page still need implementation.
...
## 7. Next: Phase 2I.2h View in Full Mushaf

Phase 2D, 2E, 2F, 2G.1, 2G.2, 2G.3, Phase 2H.1-2H.6, Phase 2I.1, Phase 2I.2a, Phase 2I.2b, Phase 2I.2c, Phase 2I.2d, Phase 2I.2e, Phase 2I.2f, Phase 2I.2g, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are complete and hardware-tested. The next active implementation item is Phase 2I.2h View in Full Mushaf action from inside the active mobile memorization session.
...
- **Current next** — Implement Phase 2I.2h View in Full Mushaf: add a session action that opens Full Quran/Mushaf at the active page/ayah context and returns cleanly to the memorization session.
...
3. **Start Phase 2I.2h next.** Implement the View in Full Mushaf action from inside the active mobile memorization session before starting skip controls or any later 2I/2J/2K/TestFlight work.
