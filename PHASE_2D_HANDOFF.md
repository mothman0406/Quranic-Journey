...
**Last updated: 2026-04-30 (Phase 2I.2k Tap-tooltip word translation + WBW audio implemented locally; local validation passed; commit/sync and hardware QA pending; beta remains blocked by 2I/2J/2K parity before TestFlight readiness)**
...
- Exact next checklist:
  ...
  4. Do not start recite-mode helpers, confetti, 2I.3/2I.4, 2J, 2K, or TestFlight readiness until 2I.2k is committed/synced and hardware-tested unless Mohammad explicitly reorders.
...
- **Current next** — Commit/sync both branches. Mohammad should hardware-test the tapped-word tooltip, WBW audio button, tap-to-seek, long-press popup, page-mode active-word behavior, blind gating, and recite-mode gating.
