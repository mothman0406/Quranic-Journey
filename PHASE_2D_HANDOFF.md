...
**Last updated: 2026-04-30 (Phase 2I.2k Tap-tooltip word translation + WBW audio local validation passed; remote sync target is final docs HEAD; hardware QA pending; beta remains blocked by 2I/2J/2K parity before TestFlight readiness)**
...
- Memorization session/settings parity: mobile now has Pause & Save completed-to picking, Save & Leave / Leave without saving / Keep Practicing, Recitation Check with score card, Ready to Recite, Just Get Tested, pre-session setup, bookmark/resume clarity, View in Full Mushaf, Skip repeat / Skip ayah controls, tappable ayah end-marker -> ayah sheet, `Next up` skip-gap behavior, and Today's/Current work freeze semantics hardware-tested. It still needs tap-tooltip word translation with WBW audio, recite-mode page helpers, celebration overlays, and a visible memorization settings page for defaults.
...
- Phase 2I Memorization parity completion is required before TestFlight: 2I.1 overview cards plus save-semantics/rating follow-up, 2I.2a Pause & Save, 2I.2b leave semantics, 2I.2c Recitation Check, 2I.2d Ready to Recite, 2I.2e Just Get Tested, 2I.2f Pre-session setup, 2I.2g bookmark/resume, 2I.2h View in Full Mushaf, 2I.2i Skip repeat / Skip ayah, 2I.2j tappable ayah end-marker sheet, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are hardware-tested; remaining session settings/defaults, tap-tooltip word translation + WBW audio, recite-mode helpers, celebration states, and a visible memorization settings/defaults page still need implementation.
...
| 2I.2 | In progress Apr 30: 2I.2a Pause & Save completed-to picker, 2I.2b Save & Leave / Leave without saving / Keep Practicing, 2I.2c Recitation Check, 2I.2d Ready to Recite, 2I.2e Just Get Tested, 2I.2f Pre-session setup, 2I.2g Bookmark / resume per session, 2I.2h View in Full Mushaf, 2I.2i Skip repeat / Skip ayah, 2I.2j Tappable ayah end-marker, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are implemented, validated, and hardware-tested. 2I.2k Tap-tooltip word translation + WBW audio is implemented in commit `4e70e1a`, passed local validation, and should be synced to final local-validation docs HEAD after this docs commit; hardware QA is pending. Preserve ayah/page modes, audio highlighting, cumulative review, reciter/speed settings, blind/blur modes, translation popup, recite mode, Recitation Check, Just Get Tested, setup behavior, bookmark semantics, daily-card freeze semantics, skip controls, ayah sheet, and mark-complete persistence. | `memorization.tsx`, `src/lib/audio.ts`, `src/lib/quran.ts`, `src/lib/settings.ts`, `mushaf.tsx` route params | Existing progress/daily-progress routes; AsyncStorage bookmark; existing Mushaf route; Quran.com WBW audio URLs for 2I.2k | Medium session/navigation risk | 2I.2a-2I.2j mobile typecheck / `git diff --check` passed and Mohammad hardware QA passed; 2I.2k mobile typecheck + `git diff --check` passed |
...
## 7. Current: Phase 2I.2k Tap-Tooltip Word Translation + WBW Audio

Phase 2D, 2E, 2F, 2G.1, 2G.2, 2G.3, Phase 2H.1-2H.6, Phase 2I.1, Phase 2I.2a, Phase 2I.2b, Phase 2I.2c, Phase 2I.2d, Phase 2I.2e, Phase 2I.2f, Phase 2I.2g, Phase 2I.2h, Phase 2I.2i, Phase 2I.2j, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are complete and hardware-tested. Phase 2I.2k Tap-tooltip word translation + WBW audio is implemented in commit `4e70e1a`, passed local validation, and should be synced to the final local-validation docs HEAD after this docs commit; hardware QA is pending.
...
- **Current next** — Mohammad should hardware-test the tapped-word tooltip, WBW audio button, tap-to-seek, long-press popup, page-mode active-word behavior, blind gating, and recite-mode gating.
- **Phase 2I next** — After 2I.2k is committed/synced and hardware-tested, continue memorization parity completion with recite-mode helpers, confetti, discovery polish, and a visible memorization settings/defaults page unless Mohammad explicitly reorders.
...
2. **Check git state.** At Phase 2I.2j hardware-QA docs start, `main`, `origin/main`, `feature/main-working-branch`, and `origin/feature/main-working-branch` were synced to `5826666fedd74c910a3a2f70093cf51d1e8f2500`; after this docs commit they should be synced to the final Phase 2I.2j hardware-confirmed docs HEAD. `safe-cumulative` can be ignored.
3. **Validate Phase 2I.2k next.** Do not start recite-mode helpers, confetti, 2I.3/2I.4, 2J, 2K, or TestFlight readiness before tap-tooltip word translation + WBW audio is validated, committed/synced, and hardware-tested unless Mohammad explicitly reorders.
