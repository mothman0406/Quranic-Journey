...
**Last updated: 2026-04-30 (Phase 2I.2k Tap-tooltip word translation + WBW audio implementation committed locally; push/sync and hardware QA pending; beta remains blocked by 2I/2J/2K parity before TestFlight readiness)**
...
- **Current next** — Commit this docs sync, then sync both branches. Mohammad should hardware-test the tapped-word tooltip, WBW audio button, tap-to-seek, long-press popup, page-mode active-word behavior, blind gating, and recite-mode gating.
