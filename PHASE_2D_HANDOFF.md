...
**Last updated: 2026-04-30 (Phase 2I.2l Recite-mode page auto-flip hardware QA passed; next up is Phase 2I.2m Recite-mode Show Word / Skip Word; beta remains blocked by 2I/2J/2K parity before TestFlight readiness)**
...
- Exact next checklist:
  1. Start Phase 2I.2m Recite-mode Show Word / Skip Word floating affordances in `artifacts/noor-mobile/app/child/[childId]/memorization.tsx`.
  2. Mirror the frozen web reference's `handleShowWord` / `handleSkipWord` behavior without tightening the matcher: Show Word reveals/unblurs only the current expected word; Skip Word advances past it and preserves the existing recite completion/check flow.
  3. Preserve review-only assignments, `Just Get Tested`, bookmark/resume, Pause & Save, Save & Leave, Ready to Recite, Recitation Check, View in Full Mushaf, Skip Repeat / Skip Ayah, ayah sheet, tapped-word tooltip/WBW audio, page auto-flip, daily-card freeze semantics, cumulative review, audio highlighting, reciter/speed settings, blind/blur modes, recite mode, and mark-complete persistence.
...
- Phase 2I Memorization parity completion is required before TestFlight: 2I.1 overview cards plus save-semantics/rating follow-up, 2I.2a Pause & Save, 2I.2b leave semantics, 2I.2c Recitation Check, 2I.2d Ready to Recite, 2I.2e Just Get Tested, 2I.2f Pre-session setup, 2I.2g bookmark/resume, 2I.2h View in Full Mushaf, 2I.2i Skip repeat / Skip ayah, 2I.2j tappable ayah end-marker sheet, 2I.2k tap-tooltip word translation + WBW audio, 2I.2l recite-mode page auto-flip, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are hardware-tested; remaining session settings/defaults, recite-mode helpers, celebration states, and a visible memorization settings/defaults page still need implementation.
...
| 2I.2 | In progress Apr 30: 2I.2a Pause & Save completed-to picker, 2I.2b Save & Leave / Leave without saving / Keep Practicing, 2I.2c Recitation Check, 2I.2d Ready to Recite, 2I.2e Just Get Tested, 2I.2f Pre-session setup, 2I.2g Bookmark / resume per session, 2I.2h View in Full Mushaf, 2I.2i Skip repeat / Skip ayah, 2I.2j Tappable ayah end-marker, 2I.2k Tap-tooltip word translation + WBW audio, 2I.2l Recite-mode page auto-flip, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are implemented, validated, and hardware-tested. Next is 2I.2m Show Word / Skip Word. Preserve ayah/page modes, audio highlighting, cumulative review, reciter/speed settings, blind/blur modes, translation popup, recite mode, Recitation Check, Just Get Tested, setup behavior, bookmark semantics, daily-card freeze semantics, skip controls, ayah sheet, tapped-word tooltip, page auto-flip, and mark-complete persistence. | `memorization.tsx`, `src/lib/audio.ts`, `src/lib/quran.ts`, `src/lib/settings.ts`, `mushaf.tsx` route params | Existing progress/daily-progress routes; AsyncStorage bookmark; existing Mushaf route; Quran.com WBW audio URLs for 2I.2k | Medium session/navigation risk | 2I.2a-2I.2l mobile typecheck / `git diff --check` passed and Mohammad hardware QA passed |
...
## 7. Current: Phase 2I.2m Recite-Mode Show Word / Skip Word

Phase 2D, 2E, 2F, 2G.1, 2G.2, 2G.3, Phase 2H.1-2H.6, Phase 2I.1, Phase 2I.2a, Phase 2I.2b, Phase 2I.2c, Phase 2I.2d, Phase 2I.2e, Phase 2I.2f, Phase 2I.2g, Phase 2I.2h, Phase 2I.2i, Phase 2I.2j, Phase 2I.2k, Phase 2I.2l, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are complete and hardware-tested. Next is Phase 2I.2m Recite-mode Show Word / Skip Word.
...
- **Current next** — Implement 2I.2m Show Word / Skip Word floating pills in the active mobile memorization session.
- **Phase 2I next** — After 2I.2m is implemented/synced and hardware-tested, continue memorization parity completion with multi-page recite navigation pills, confetti, discovery polish, and a visible memorization settings/defaults page unless Mohammad explicitly reorders.
...
2. **Check git state.** At Phase 2I.2l hardware-QA docs start, `main`, `origin/main`, `feature/main-working-branch`, and `origin/feature/main-working-branch` were synced to `15571ae83b90f032dbab4a224875f173ed4b4d59`; after this docs commit they should be synced to the final Phase 2I.2l hardware-confirmed docs HEAD. `safe-cumulative` can be ignored.
3. **Implement Phase 2I.2m next.** Do not start confetti, 2I.3/2I.4, 2J, 2K, or TestFlight readiness before Show Word / Skip Word is implemented, committed/synced, and hardware-tested unless Mohammad explicitly reorders.
