...
**Last updated: 2026-04-30 (Phase 2I.2j Tappable ayah end-marker hardware QA passed; next is Phase 2I.2k Tap-tooltip word translation + WBW audio; beta remains blocked by 2I/2J/2K parity before TestFlight readiness)**
...
- Exact next checklist:
  1. Start Phase 2I.2k Tap-tooltip word translation + WBW audio in the active mobile memorization session.
  2. Use the frozen web reference in `artifacts/noor-path/src/pages/quran-memorize.tsx` for tapped-word behavior, but do not edit `artifacts/noor-path`.
  3. Keep existing long-press translation popup and tap-to-seek behavior. Add the new tooltip in a way that does not break current seek/playback, page/ayah modes, blind/blur behavior, recite mode, cumulative review, skip controls, bookmark/resume, Pause & Save, Save & Leave, Ready to Recite, Recitation Check, Just Get Tested, View in Full Mushaf, ayah sheet, and mark-complete persistence.
  4. Use Quran.com WBW audio URLs only for the new word audio button: `https://audio.qurancdn.com/wbw/{surah}_{verse}_{position}.mp3` with zero-padded 3-digit values. Do not add native dependencies.
  5. Do not start recite-mode helpers, confetti, 2I.3/2I.4, 2J, 2K, or TestFlight readiness until 2I.2k is implemented, documented, validated, and hardware-tested unless Mohammad explicitly reorders.
...
| 2I.2 | In progress Apr 30: 2I.2a Pause & Save completed-to picker, 2I.2b Save & Leave / Leave without saving / Keep Practicing, 2I.2c Recitation Check, 2I.2d Ready to Recite, 2I.2e Just Get Tested, 2I.2f Pre-session setup, 2I.2g Bookmark / resume per session, 2I.2h View in Full Mushaf, 2I.2i Skip repeat / Skip ayah, 2I.2j Tappable ayah end-marker, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are implemented, validated, and hardware-tested. Next is 2I.2k Tap-tooltip word translation + WBW audio. Preserve ayah/page modes, audio highlighting, cumulative review, reciter/speed settings, blind/blur modes, translation popup, recite mode, Recitation Check, Just Get Tested, setup behavior, bookmark semantics, daily-card freeze semantics, skip controls, ayah sheet, and mark-complete persistence. | `memorization.tsx`, `src/lib/settings.ts`, `mushaf.tsx` route params | Existing progress/daily-progress routes; AsyncStorage bookmark; existing Mushaf route; Quran.com WBW audio URLs for 2I.2k | Medium session/navigation risk | 2I.2a-2I.2j mobile typecheck / `git diff --check` passed and Mohammad hardware QA passed |
...
## 7. Next: Phase 2I.2k Tap-Tooltip Word Translation + WBW Audio

Phase 2D, 2E, 2F, 2G.1, 2G.2, 2G.3, Phase 2H.1-2H.6, Phase 2I.1, Phase 2I.2a, Phase 2I.2b, Phase 2I.2c, Phase 2I.2d, Phase 2I.2e, Phase 2I.2f, Phase 2I.2g, Phase 2I.2h, Phase 2I.2i, Phase 2I.2j, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are complete and hardware-tested. The next active slice is Phase 2I.2k Tap-tooltip word translation + WBW audio.
...
- **Current next** — Implement 2I.2k in the active mobile memorization session: tapped-word tooltip with Arabic word, English translation, word position, and WBW audio playback.
- **Phase 2I next** — After 2I.2k is implemented, documented, validated, and hardware-tested, continue memorization parity completion with recite-mode helpers, confetti, discovery polish, and a visible memorization settings/defaults page unless Mohammad explicitly reorders.
...
3. **Start Phase 2I.2k next.** Do not start recite-mode helpers, confetti, 2I.3/2I.4, 2J, 2K, or TestFlight readiness before tap-tooltip word translation + WBW audio is implemented, documented, validated, and hardware-tested unless Mohammad explicitly reorders.
