...
**Last updated: 2026-04-30 (Phase 2I.2h View in Full Mushaf hardware QA passed; next is Phase 2I.2i Skip repeat / Skip ayah; beta remains blocked by 2I/2J/2K parity before TestFlight readiness)**
...
- Exact next checklist:
  1. Start Phase 2I.2i Skip repeat / Skip ayah toolbar controls in the active mobile memorization session.
  2. Add Skip Repeat and Skip Ayah controls near the existing Prev / Play / Next row so a child can move on without finishing all repeats or the current ayah.
  3. Preserve cumulative-review behavior: Skip Repeat during cumulative review should advance the current cumulative pass/step, and Skip Ayah during cumulative review should exit cumulative review appropriately without corrupting the single-phase cursor.
  ...
  5. Do not start 2I.2j, 2I.3/2I.4, 2J, 2K, or TestFlight readiness until 2I.2i is implemented, documented, validated, and hardware-tested unless Mohammad explicitly reorders.
...
- Phase 2I Memorization parity completion is required before TestFlight: 2I.1 overview cards plus save-semantics/rating follow-up, 2I.2a Pause & Save, 2I.2b leave semantics, 2I.2c Recitation Check, 2I.2d Ready to Recite, 2I.2e Just Get Tested, 2I.2f Pre-session setup, 2I.2g bookmark/resume, 2I.2h View in Full Mushaf, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are hardware-tested; remaining session settings/defaults, skip controls, richer ayah/word actions, recite-mode helpers, celebration states, and a visible memorization settings/defaults page still need implementation.
...
## 7. Next: Phase 2I.2i Skip Repeat / Skip Ayah

Phase 2D, 2E, 2F, 2G.1, 2G.2, 2G.3, Phase 2H.1-2H.6, Phase 2I.1, Phase 2I.2a, Phase 2I.2b, Phase 2I.2c, Phase 2I.2d, Phase 2I.2e, Phase 2I.2f, Phase 2I.2g, Phase 2I.2h, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are complete and hardware-tested. The next active implementation item is Phase 2I.2i Skip repeat / Skip ayah toolbar controls.
...
- **Current next** — Implement Phase 2I.2i Skip repeat / Skip ayah: add controls near Prev / Play / Next so the child can advance repeat passes or skip the current ayah without finishing all repeats, while preserving cumulative review semantics.
...
2. **Check git state.** At Phase 2I.2h hardware-QA docs start, `main`, `origin/main`, `feature/main-working-branch`, and `origin/feature/main-working-branch` were synced to `36622e5ad0805e491a886b4f636c900c933915ef`; after this docs update they should be synced to the final docs HEAD. `safe-cumulative` can be ignored.
3. **Start Phase 2I.2i next.** Implement Skip repeat / Skip ayah toolbar controls before starting ayah sheets or any later 2I/2J/2K/TestFlight work.
