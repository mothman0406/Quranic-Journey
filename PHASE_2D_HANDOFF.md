...
**Last updated: 2026-04-30 (Phase 2I.2j Tappable ayah end-marker local validation passed; hardware QA pending; beta remains blocked by 2I/2J/2K parity before TestFlight readiness)**
...
- Exact next checklist:
  1. Commit/sync `main` and `feature/main-working-branch` to the final Phase 2I.2j local-validation HEAD.
  2. Hardware QA: tap the ayah-mode marker, tap a page-mode marker, confirm the sheet appears, `Practice from this ayah` moves the current session cursor safely, `View in Full Mushaf` opens that ayah/page and Back returns to the mounted session, recite mode disables marker actions, hidden blind-mode ayahs do not open the sheet, revealed blind-mode ayahs can open it, word tap-to-seek still works, and long-press translation still works.
  3. Do not start 2I.2k, 2I.3/2I.4, 2J, 2K, or TestFlight readiness until 2I.2j is committed, synced, and hardware-tested unless Mohammad explicitly reorders.
...
- Memorization session/settings parity: mobile now has Pause & Save completed-to picking, Save & Leave / Leave without saving / Keep Practicing, Recitation Check with score card, Ready to Recite, Just Get Tested, pre-session setup, bookmark/resume clarity, View in Full Mushaf, Skip repeat / Skip ayah controls, `Next up` skip-gap behavior, and Today's/Current work freeze semantics hardware-tested. It still needs richer ayah/word actions, recite-mode page helpers, celebration overlays, and a visible memorization settings page for defaults.
...
- Phase 2I Memorization parity completion is required before TestFlight: 2I.1 overview cards plus save-semantics/rating follow-up, 2I.2a Pause & Save, 2I.2b leave semantics, 2I.2c Recitation Check, 2I.2d Ready to Recite, 2I.2e Just Get Tested, 2I.2f Pre-session setup, 2I.2g bookmark/resume, 2I.2h View in Full Mushaf, 2I.2i Skip repeat / Skip ayah, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are hardware-tested; 2I.2j ayah end-marker actions are implemented and locally validated with hardware QA pending; remaining session settings/defaults, richer word actions, recite-mode helpers, celebration states, and a visible memorization settings/defaults page still need implementation.
...
| 2I.2 | In progress Apr 30: 2I.2a Pause & Save completed-to picker, 2I.2b Save & Leave / Leave without saving / Keep Practicing, 2I.2c Recitation Check, 2I.2d Ready to Recite, 2I.2e Just Get Tested, 2I.2f Pre-session setup, 2I.2g Bookmark / resume per session, 2I.2h View in Full Mushaf, 2I.2i Skip repeat / Skip ayah, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are implemented, validated, and hardware-tested. 2I.2j Tappable ayah end-marker is implemented and locally validated with hardware QA pending. Preserve ayah/page modes, audio highlighting, cumulative review, reciter/speed settings, blind/blur modes, translation popup, recite mode, Recitation Check, Just Get Tested, setup behavior, bookmark semantics, daily-card freeze semantics, skip controls, and mark-complete persistence. | `memorization.tsx`, `src/lib/settings.ts`, `mushaf.tsx` route params | Existing progress/daily-progress routes; AsyncStorage bookmark; existing Mushaf route | Medium session/navigation risk | 2I.2a-2I.2i mobile typecheck / `git diff --check` passed and Mohammad hardware QA passed; 2I.2j mobile typecheck / `git diff --check` passed |
...
| **2I.2j Tappable ayah end-marker** | 🟡 local validation passed | pending hardware QA | Ayah-mode marker and page-mode end markers open a focused Ayah actions sheet when allowed; actions are `Practice from this ayah` and `View in Full Mushaf` at that ayah |
...
## 7. Next: Validate Phase 2I.2j Tappable Ayah End-Marker

Phase 2D, 2E, 2F, 2G.1, 2G.2, 2G.3, Phase 2H.1-2H.6, Phase 2I.1, Phase 2I.2a, Phase 2I.2b, Phase 2I.2c, Phase 2I.2d, Phase 2I.2e, Phase 2I.2f, Phase 2I.2g, Phase 2I.2h, Phase 2I.2i, the `Next up` skip-gap fix, and the Today's/Current work freeze correction are complete and hardware-tested. Phase 2I.2j Tappable ayah end-marker -> ayah sheet is implemented and locally validated; hardware QA is pending.
...
- **Current next** — Commit/sync Phase 2I.2j, then hardware-test the ayah/page markers, focused sheet actions, recite/blind gating, word tap-to-seek, and long-press translation.
- **Phase 2I next** — After 2I.2j is hardware-tested, continue memorization parity completion with word actions, recite-mode helpers, confetti, discovery polish, and a visible memorization settings/defaults page unless Mohammad explicitly reorders.
...
2. **Check git state.** At Phase 2I.2j implementation start, `main`, `origin/main`, `feature/main-working-branch`, and `origin/feature/main-working-branch` were synced to `c8cf9f48b9663566e0ea17677b2a85244778f6f6`; after the validation/docs commit they should be synced to the final Phase 2I.2j local-validation HEAD. `safe-cumulative` can be ignored.
3. **Hardware-test Phase 2I.2j next after commit/sync.** Do not start word tooltip/WBW audio or any later 2I/2J/2K/TestFlight work first.
