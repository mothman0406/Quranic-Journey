...
_Last updated: April 29, 2026 (Today's/Current work freeze correction hardware QA passed; next is Phase 2I.2f pre-session setup)_
...
## 🔜 NEXT — Phase 2I.2f Pre-session Setup

1. Implement a setup phase before memorization playback in `artifacts/noor-mobile/app/child/[childId]/memorization.tsx`.
2. Controls: From/To ayah inputs bounded by the selected surah/range, repeat count 1-10, auto-advance toggle, cumulative review toggle, review repeat count stepper when cumulative review is on, and surah navigation/dropdown.
3. CTA: `Start - Ayah X to Y`; review-only assignments should keep a `Just Get Tested` shortcut that skips playback and routes to Recitation Check.
4. Preserve existing 2I.2a/2I.2b/2I.2c/2I.2d/2I.2e behavior and the hardware-tested daily-card freeze semantics.
...
| Mobile app HEAD | Phase 2D complete through Slice 5b, Phase 2E dashboard polish complete, Phase 2F targets complete, Phase 2G.1-2G.3 hardware-tested, Phase 2H.1-2H.6 hardware-tested, Phase 2I.1 memorization overview cards plus save-semantics/rating follow-up hardware-tested, Phase 2I.2a Pause & Save hardware-tested, Phase 2I.2b Save & Leave hardware-tested, Phase 2I.2c Recitation Check hardware-tested, Phase 2I.2d Ready to Recite hardware-tested, Phase 2I.2e Just Get Tested hardware-tested, `Next up` skip-gap behavior hardware-tested, and Today's/Current work freeze correction hardware-tested. Backend cumulative recitation scheduling was corrected during Phase 2I.1 QA. EAS dev build `cfb3f406-5fec-405a-a150-e525a96ecff2` finished and was hardware-tested by Mohammad for earlier slices. Beta is not done; next recommended work is Phase 2I.2f Pre-session setup, followed by remaining 2I.2, 2I.3/2I.4, and Phase 2J/2K blockers before TestFlight readiness. |
</content>
