...
_Last updated: April 29, 2026 (Phase 2I.1 hardware QA pending; Bug A/B/C hardware-tested/shipped)_
...
- Exact next checklist:
  ...
  10. Smoke search/filter/resume/session flow, including that Needs Work → Practice still loads without spinning.
...
9. Smoke search/filter/resume/session flow, including Needs Work → Practice loading.
