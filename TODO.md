...
- Exact next checklist:
  1. Mohammad hardware-tests Phase 2I.1: open Memorize from dashboard; confirm `Today's work`, `Current work`/`Recitation Focus`, and `Next up`; complete today's work; choose Needs Work/Good/Excellent and save; confirm today's card remains the same assignment marked done/in-progress; confirm saved strength shows red/yellow/green where applicable; complete extra work if possible and confirm `Next up` can change while today remains today; return to dashboard and confirm dashboard refresh; smoke search/filter/resume/session flow.
...
3. Confirm today's card stays the same assignment and shows done/in-progress instead of advancing to tomorrow's work.
