...
2. Memorization: mobile has the core learner, 2H.6 discovery, and locally implemented 2I.1 overview cards. The immediate next fix is save semantics/rating: post daily progress for today's work and require Needs Work/Good/Excellent before save. Web still defines the required next work after that: explicit setup/defaults, Pause & Save/leave flows, teacher/app recitation check, View in Full Mushaf, and resume/bookmark clarity. Do not touch recite matcher behavior. Do not pursue tajweed beyond documenting it as backlogged.
